      ...
      for (l in 1){
        for (nn in 1){
          for(i_ in 1){
            ...
            outfile1 <- paste("sim_t1e_SCLMM_pval_",n1,"_",n2,"_",L,"_",M,"_",rho,"_",q1,"_",
                              q2,"_",h2y,"_",beta_prop,"_",h2,"_",lam, ".txt",sep="")
            outfile2 <- paste("sim_t1e_SCLMM_alpha_",n1,"_",n2,"_",L,"_",M,"_",rho,"_",q1,"_",
                              q2,"_",h2y,"_",beta_prop,"_",h2,"_",lam, ".txt",sep="")
